...
- **Tailwind CSS v4**: Utility-first CSS framework configured with custom theme variables for a dark-mode high-density charcoal aesthetic (`#131313`, `#2E2E2E`, `#c0c1ff`).
